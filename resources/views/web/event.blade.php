<head>
	...
	<title>L&M &mdash; O Evento</title>
	...
	<style>
    body{
        background:linear-gradient(0deg, rgba(39, 21, 21, 0.849), rgb(43 41 41 / 50%)), url('../assets/images/img_bg_3.jpg');
